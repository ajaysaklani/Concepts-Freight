...
<body <?php body_class(); ?>>
	...
	<div class="sub-header">
			<div class="container">
				...
				<?php if ( !function_exists('dynamic_sidebar') || !dynamic_sidebar('top-header-left') ) : endif; ?>
			 </div>
			 
			 <div class="top-header-right">
				<?php if ( !function_exists('dynamic_sidebar') || !dynamic_sidebar('top-header-right') ) : endif; ?>
			 </div>
